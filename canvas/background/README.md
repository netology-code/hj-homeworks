...
При этом вычислять текущее положение каждого объекта необходимо от его изначального положения. А не от измененного в предыдущий тик. Так как формула расчета положения задаёт колебания вокруг базовой точки, которой будет первично сгенерированный координаты при создании объекта.
